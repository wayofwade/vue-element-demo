<template>
  <div class="tree-table">
    <div class="tree-head">
      ...
      <table>
        <tr>
          <td class="td1 table-title-font">分类</td>
          <td class="td2 table-title-font">目录级别</td>
          <!--<td class="td3 table-title-font" @click="isDesc=!isDesc">
            创建时间
            <div class="arrow">
          ...
          <td class="td4 table-title-font">数量</td>
          <td class="td5 table-title-font">状态</td>
          <td class="td6 table-title-font">操作</td>
        </tr>
      </table>
    </div>
...
<style lang="scss" scoped>
  .tree-table {
    ...
    .td1 {width: 260px;padding-left:30px;box-sizing: border-box;}
    .td2 {width: 100px;}
    .td3 {width: 120px;}
    .td4 {width: 130px;}
    .td5 {width: 100px;}
    .td6 {width: 240px; padding-left: 80px;box-sizing: border-box}
